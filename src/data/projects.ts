...
export const dataEngineeringProjects: Project[] = [
  ...
  },
  {
    ...
    images: [
      ...
      { src: "/projects/ecommerce-ssis/ERD_Source.webp", caption: "Source database ERD" },
    ],
  ...
  },
  {
    ...
    images: [
      ...
      { src: "/projects/fraud-detection/ERD.webp", caption: "Data warehouse entity relationship diagram" },
    ],
    githubUrl: null,
    demoUrl: null,
  },
...
export const dataAnalyticsProjects: Project[] = [
  {
    ...
    images: [
      ...
      { src: "/projects/ecommerce-dashboard/Customer_Page.webp", caption: "Customer Analysis — LTV, retention, geography" },
      { src: "/projects/ecommerce-dashboard/Returns_Page.webp", caption: "Returns Profitability — refund impact and root causes" },
    ],
    githubUrl: null,
    demoUrl: null,
  },
  {
    ...
    images: [
      ...
      { src: "/projects/egx-dashboard/signals&risk.webp", caption: "Signals & Risk — RSI screening, risk scatter" },
      { src: "/projects/egx-dashboard/live_ticks.webp", caption: "Live Ticks — real-time market feed" },
    ],
    githubUrl: null,
    demoUrl: null,
  },
